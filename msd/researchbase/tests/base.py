...
def setup_product():
    ...
    import msd.researchbase
    zcml.load_config('configure.zcml', msd.researchbase)
    ...
    ztc.installPackage('msd.researchbase')
...
setup_product()
ptc.setupPloneSite(products=['msd.researchbase'])
